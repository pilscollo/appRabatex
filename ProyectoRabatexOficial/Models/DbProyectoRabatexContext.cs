...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-V5IU507\\SQLEXPRESS;Database=dbProyectoRabatexOfi;Trusted_Connection=true;User=sa;Password=1234;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IngresoProducto>(entity =>
        {
            ...
            entity.Property(e => e.IdRelacion).ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<IngresoCliente>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.IngresoClientes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IngresoCliente_Cliente");

            entity.HasOne(d => d.IdIngresoNavigation).WithMany(p => p.IngresoClientes)
                .HasForeignKey(d => d.IdIngreso)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IngresoCliente_Ingreso");
        });
